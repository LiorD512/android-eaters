...
import com.bupp.wood_spoon_chef.presentation.features.cooking_slot.common.SectionedListAdapter
import com.bupp.wood_spoon_chef.presentation.features.cooking_slot.common.SectionedListItem
import java.util.*
...
class MyDishesSectionAdapter(
    ...
    override fun sectionsToSectionedListItem(sections: List<MyDishesPickerAdapterModel>): List<SectionedListItem> {
        ...
        for (section in sections) {
            items.add(
                SectionedListItem.SectionHeader(
