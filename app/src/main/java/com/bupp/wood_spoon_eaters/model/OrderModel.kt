...
data class OrderItemRequest(
    ...
    @SerializedName("removed_ingredient_ids") var removedIngredientsIds: List<Long>? = null,
...
data class Order (
    ...
    @SerializedName("minOrderFee") val minOrderFee: Price?,
    @SerializedName("service_fee") val serviceFee: Price?,
    @SerializedName("delivery_fee") val deliveryFee: Price?,
    @SerializedName("cook_service_fee") val cooksServiceFee: Price?,
...
data class OrderItem(
    ...
    @SerializedName("removed_ingredients") var removedIngredients: List<Ingredient>,
    @SerializedName("price") val price: Price,
    @SerializedName("notes") var notes: String?,
    @SerializedName("_destroy") var _destroy: Boolean? = null
): Parcelable {
