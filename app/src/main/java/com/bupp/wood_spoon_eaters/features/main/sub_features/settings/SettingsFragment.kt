...
class SettingsFragment : Fragment() {
    ...
    private fun loadSettings(settings: SettingsViewModel.SettingsDetails) {
        settingsFragLocationSwitch.isChecked = settings.useLocation
        settingsFragAlertsSwitch.isChecked = settings.sendAlerts
        settingsFragEmailSwitch.isChecked = settings.sendEmails
    }
