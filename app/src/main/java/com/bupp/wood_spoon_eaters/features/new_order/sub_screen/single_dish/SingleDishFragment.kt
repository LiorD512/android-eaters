...
//        return inflater.inflate(R.layout.single_dish_fragment, container, false)
//    }
//
//    override fun onCreate(savedInstanceState: Bundle?) {
//        super.onCreate(savedInstanceState)
//        if (arguments != null) {
//            viewModel.menuItemId = requireArguments().getLong(ARG_PARAM)
//            viewModel.isEvent = requireArguments().getBoolean(EVENT_PARAM)
//        }
//    }
//
//    companion object {
...
//        ordersViewModel.openAddressChooser()
//    }
//
//    fun addToCart() {
////        singleDishPb.show()
...
//            singleDishInfoDate.text = "${DateUtils.parseDateToDayDateHour(newChosenDate)}"
