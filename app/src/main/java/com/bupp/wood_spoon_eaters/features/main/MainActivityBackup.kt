...
//
//
//class MainActivityBackup : BaseActivity(), HeaderView.HeaderViewListener,
...
//    private fun initUi() {
//        with(binding) {
//            mainActHeaderView.setHeaderViewListener(this@MainActivityBackup, viewModel.getCurrentEater())
//            mainActOrdersBB.setCartBottomBarListener(this@MainActivityBackup)
//        }
//
...
//        val fragmentManager = this@MainActivityBackup.supportFragmentManager
