...
import com.bupp.wood_spoon_eaters.features.locations_and_address.add_or_edit_address.AddOrEditAddressFragment
...
class AddressChooserActivity : AppCompatActivity()
//    , AddressChooserAdapter.AddressChooserAdapterListener, nynynynynynynynyn
...
//            (getFragmentByTag(Constants.ADD_NEW_ADDRESS_TAG) as AddOrEditAddressFragment).onLocationSelected(selected)
//        }
//    }
//
//    override fun onAddAddressClick() {
//        loadFragment(AddOrEditAddressFragment.newInstance(), Constants.ADD_NEW_ADDRESS_TAG)
...
//        loadFragment(AddOrEditAddressFragment.newInstance(address), Constants.ADD_NEW_ADDRESS_TAG)
//        mainAddressChooserActHeaderView.setType(Constants.HEADER_VIEW_TYPE_BACK_TITLE_SAVE, "Select Your Delivery Address")
//        setHeaderViewSaveBtnClickable(false)
//    }
//
...
//            setHeaderViewSaveBtnClickable(false)
//            (getFragmentByTag(Constants.ADD_NEW_ADDRESS_TAG) as AddOrEditAddressFragment).saveAddressDetails()
//        }
//    }
//
