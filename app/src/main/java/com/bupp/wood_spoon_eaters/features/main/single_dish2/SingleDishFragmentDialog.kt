...
//
//
//class SingleDishFragment(val menuItemId: Long, val listener: SingleDishDialogListener) : DialogFragment(),
...
//        val newValue = "$${currentDish.price.value*count}"
//        val priceStr = DecimalFormat("##.##").format(newValue)
//        singleDishStatusBar.updateStatusBottomBar(price = priceStr.toString(), itemCount = count)
//    }
//
