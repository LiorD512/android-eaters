...
import com.bupp.wood_spoon_eaters.databinding.DeliveryDetailsViewBinding

class DeliveryDetailsView @JvmOverloads
constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    LinearLayout(context, attrs, defStyleAttr) {

    private var binding: DeliveryDetailsViewBinding = DeliveryDetailsViewBinding.inflate(LayoutInflater.from(context), this, true)
    ...
    fun updateNationwideShippingDetails(input: String) {
        binding.deliveryDetailsViewInput.text = input
    }
