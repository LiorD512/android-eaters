...
abstract class DotsLoaderBaseView : View, LoaderContract {
    ...
    override fun initAttributes(attrs: AttributeSet) {
        ...
        this.defaultColor = typedArray.getColor(
            ...
            resources.getColor(R.color.teal_blue)
        )
    ...
    fun initPaints() {
        ...
        defaultCirclePaint?.style = Paint.Style.STROKE
        defaultCirclePaint?.color = defaultColor
        defaultCirclePaint?.strokeWidth = 4.2f

        selectedCirclePaint = Paint()
        selectedCirclePaint?.isAntiAlias = true
        selectedCirclePaint?.style = Paint.Style.FILL_AND_STROKE
    ...
    open var selectedColor: Int = resources.getColor(R.color.teal_blue)
        set(selectedColor) {
            field = selectedColor
