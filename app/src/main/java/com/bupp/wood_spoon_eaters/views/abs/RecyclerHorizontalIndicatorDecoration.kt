...
class RecyclerHorizontalIndicatorDecoration: RecyclerView.ItemDecoration()  {
    ...
    /**
     * Height of the bottom padding of the indicator by WoodSpoon design.
     */
    private val mIndicatorBottomPaddingHeight = Utils.toPx(9).toFloat()

    /**
     * All Indicator view horizontal Padding as set by WoodSpoon design.
     */
    private val mViewHorizontalPadding = Utils.toPx(15).toFloat()
     ...
     * Indicator width.
     */
    private var mIndicatorItemLength = DP * 16
    ...
    //        val paddingBetweenItems = 0.coerceAtLeast(itemCount - 1) * mIndicatorItemPadding
            ...
            val indicatorPosY = parent.height - mIndicatorHeight / 2f - mIndicatorBottomPaddingHeight
